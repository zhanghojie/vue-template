      ...
      <div class="top">
        ...
        <div class="main">
          <div class="classify">
            ...
            <div @click="ActiveChange1" :class="[isActive == 1 ? 'active' : '']">未开始</div>
            <div @click="ActiveChange2" :class="[isActive == 2 ? 'active' : '']">进行中</div>
            <div @click="ActiveChange3" :class="[isActive == 2 ? 'active' : '']">已完成</div>
          </div>
        </div>
      </div>
    </div>
