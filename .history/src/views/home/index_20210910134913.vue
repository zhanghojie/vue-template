...
import {JSUserInfoInterface} from '../../../static/common';
import $ from '../../../static/jquery-1.10.2';
export default {
  data() {
    return {
      isActive: 0,
  ...
  methods: {
    ...
    initData() {
      ...
      function onDeviceReady() {
        function loadData() {
          HTMICordovaSuport.getSystemVariables('|user_id|,|app_id|,|accessToken|', function (res) {
            console.log(res, 'res');
      ...
      try {
        var userInfo = JSUserInfoInterface.getUserInfo();
