<template>
  <div class="container">
    ...
    <van-cell-group>
      ...
      <van-cell title="监察项目" value="请选择" is-link @click="jcxmClick" />
      <van-cell title="监察要点" value="请选择" is-link @click="jcydClick" />
    </van-cell-group>
...
export default {
  ...
  methods: {
    ...
    onSelect1(item) {
      console.log(item);
      const {issueType, issueSubtypes} = item;
    ...
    onSelect2(item) {
      const {issueSubtype, issueSubtypeItems} = item;
