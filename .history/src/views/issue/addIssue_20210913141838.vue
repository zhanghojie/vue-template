<template>
  <div class="container">
    ...
    <van-action-sheet v-model="show1" :actions="actions1" @select="onSelect1" @cancel="show1 = false" cancel-text="取消" close-on-click-action />
    <van-action-sheet v-model="show2" :actions="actions2" @select="onSelect2" @cancel="show2 = false" cancel-text="取消" close-on-click-action />
    <van-action-sheet v-model="show3" :actions="actions3" @select="onSelect3" @cancel="show3 = false" cancel-text="取消" close-on-click-action />
  </div>
</template>
